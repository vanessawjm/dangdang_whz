			...
			<p>
				...
				<script type="text/javascript">
					function changeAddress(addressId){
						window.location.href="${pageContext.request.contextPath}/address/selectAddressById?addressId="+addressId;
					}
				</script>
			</p>
			<form name="ctl00" method="post" action="${pageContext.request.contextPath }/order/addOrder" id="f">
				<input type="hidden" name="address.id" value="${address.id }" />
				<input type="hidden" name="address.userId" value="${loginUser.id }" />
